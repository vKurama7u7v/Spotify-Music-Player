            ...
            <div class="lg:flex lg:items-center">
              <div class="flex items-center justify-between">
                <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                  <div class="w-10 h-10 text-white p-2 bg-green-500 rounded-full flex items-center justify-center">
                    <i class="uil uil-headphones-alt text-lg"></i>
                  </div>
                  <span class="ml-3 text-xl font-semibold">SoundWave.io</span>
                </a>
              ...
              >
                <div class="flex flex-col text-gray-600 capitalize  lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
                  <a
                    href="#"
                    class="mt-2 transition-colors duration-300 transform lg:mt-0 lg:mx-4 hover:text-gray-900 "
                  >
                    features
                  </a>
                  <a
                ...
                <div class="flex justify-center mt-6 lg:flex lg:mt-0 lg:-mx-2">
                  <a
                    href="#"
                    class="mx-2 text-gray-600 transition-colors duration-300 transform "
                    aria-label="Reddit"
                  >
                    <svg
